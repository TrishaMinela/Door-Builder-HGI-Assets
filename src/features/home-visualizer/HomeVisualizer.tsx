...
export function HomeVisualizer({ onBack, onReturnToReview, onDownloadPdf, configuredDoorPreview, configurationKey }: Props) {
  ...
  useEffect(() => {
    // Frame-area recoloring is only a placement aid. The completed product
    // already contains the canonical DoorPreview jamb/frame finish, so never
    // tint the house photo beneath that flattened entrance a second time.
