...
const glassThumbnailOptions = [
  ...
  { id: 'berkley', name: 'Berkley', image: '/assets/glass/thumbnails/Berkley.png' },
  { id: 'blanca', name: 'Blanca', image: '/assets/glass/thumbnails/Blanca.png' },
  ...
  { id: 'calandra', name: 'Calandra', image: '/assets/glass/thumbnails/Calandra.png' },
  { id: 'carrollton', name: 'Carrollton', image: '/assets/glass/thumbnails/Carrollton.png' },
  { id: 'catalina', name: 'Catalina', image: '/assets/glass/thumbnails/Catalina.png' },
  { id: 'chinchilla', name: 'Chinchilla', image: '/assets/glass/thumbnails/Chinchilla.png' },
  { id: 'clear', name: 'Clear Glass - Standard', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'clear-low-e', name: 'Clear Glass - Low-E', image: '/assets/glass/thumbnails/Clear-option.png' },
  ...
  { id: 'crosswalk', name: 'Crosswalk', image: '/assets/glass/thumbnails/Crosswalk.png' },
  ...
  { id: 'cyndi', name: 'Cyndi', image: '/assets/glass/thumbnails/Cyndi.png' },
  ...
  { id: 'edgewood', name: 'Edgewood', image: '/assets/glass/thumbnails/Edgewood.png' },
  { id: 'elegant', name: 'Elegant', image: '/assets/glass/thumbnails/Elegant.png' },
  { id: 'empire', name: 'Empire', image: '/assets/glass/thumbnails/Empire.png' },
  ...
  { id: 'fragrance', name: 'Fragrance', image: '/assets/glass/thumbnails/Fragrance.png' },
  { id: 'frosted', name: 'Frosted', image: '/assets/glass/thumbnails/Frosted.png' },
  { id: 'garrison', name: 'Garrison', image: '/assets/glass/thumbnails/Decorative.png' },
  { id: 'geneva', name: 'Geneva', image: '/assets/glass/thumbnails/Geneva.png' },
  ...
  { id: 'high-point', name: 'High Point', image: '/assets/glass/thumbnails/High Point.png' },
  { id: 'jacinto', name: 'Jacinto', image: '/assets/glass/thumbnails/Jacinto.png' },
  { id: 'jameston', name: 'Jameston', image: '/assets/glass/thumbnails/Jameston.png' },
  { id: 'laurel', name: 'Laurel', image: '/assets/glass/thumbnails/Laurel.png' },
  ...
  { id: 'london', name: 'London', image: '/assets/glass/thumbnails/London.png' },
  ...
  { id: 'margate', name: 'Margate', image: '/assets/glass/thumbnails/Margate.png' },
  { id: 'metro', name: 'Metro', image: '/assets/glass/thumbnails/Metro.png' },
  { id: 'micro-granite', name: 'Micro Granite', image: '/assets/glass/thumbnails/Micro Granite.png' },
  ...
  { id: 'monterey', name: 'Monterey', image: '/assets/glass/thumbnails/Monterey.png' },
  { id: 'neo', name: 'Neo', image: '/assets/glass/thumbnails/Neo.png' },
  ...
  { id: 'pembrook', name: 'Pembrook', image: '/assets/glass/thumbnails/Pembrook.png' },
  { id: 'prestige', name: 'Prestige', image: '/assets/glass/thumbnails/Prestige.png' },
  { id: 'privacy', name: 'Private Lites', image: '/assets/glass/thumbnails/Private Lites.png' },
  ...
  { id: 'riverwood', name: 'Riverwood', image: '/assets/glass/thumbnails/Riverwood.png' },
  ...
  { id: 'vilano', name: 'Vilano', image: '/assets/glass/thumbnails/Vilano.png' },
  { id: 'vincraft', name: 'Vincraft', image: '/assets/glass/thumbnails/VINCRAFT.jpg' },
  { id: 'waterside', name: 'Waterside', image: '/assets/glass/thumbnails/Waterside.png' },
  { id: 'wyngate', name: 'Wyngate', image: '/assets/glass/thumbnails/Wyngate.png' },
]
...
const variantThumbnailOptions = [
  { id: 'baroque', name: 'Baroque', image: '/assets/glass/thumbnails/Baroque.png' },
  { id: 'cr14pl-dorian', name: 'Dorian', image: '/assets/glass/thumbnails/DORIAN.png' },
  { id: 'cr14pl-monterey', name: 'Monterey', image: '/assets/glass/thumbnails/Monterey.png' },
  { id: 'double-water', name: 'Double Water', image: '/assets/glass/thumbnails/CR14PL Double Water.png' },
  { id: 'streamed', name: 'Streamed', image: '/assets/glass/thumbnails/Streamed.png' },
  ...
  { id: 'ca-heirloom-brass', name: 'Heirloom - Brass', image: '/assets/glass/thumbnails/Heirlooms - Brass.png' },
  { id: 'ca-heirloom-nickel', name: 'Heirloom - Nickel', image: '/assets/glass/thumbnails/Heirlooms - Nickel.png' },
  { id: 'ca-grace-nickel', name: 'Grace - Nickel', image: '/assets/glass/thumbnails/Grace - Nickel.png' },
  { id: 'ca-grace-patina', name: 'Grace - Patina', image: '/assets/glass/thumbnails/Grace - Patina.png' },
  { id: 'dorian-nickel', name: 'Dorian - Nickel', image: '/assets/glass/thumbnails/Dorian - Nickel.png' },
  { id: 'dorian-patina', name: 'Dorian - Patina', image: '/assets/glass/thumbnails/Dorian - Patina.png' },
  { id: 'elegant-black-white', name: 'Elegant - Black/White', image: '/assets/glass/thumbnails/Elegant - Black_White.png' },
  { id: 'elegant-nickel', name: 'Elegant - Nickel', image: '/assets/glass/thumbnails/Elegant - Nickel.png' },
  { id: 'elegant-patina', name: 'Elegant - Patina', image: '/assets/glass/thumbnails/Elegant - Patina.png' },
  { id: 'grace-nickel', name: 'Grace - Nickel', image: '/assets/glass/thumbnails/Grace - Nickel.png' },
  { id: 'grace-patina', name: 'Grace - Patina', image: '/assets/glass/thumbnails/Grace - Patina.png' },
  { id: 'heirlooms-brass', name: 'Heirlooms - Brass', image: '/assets/glass/thumbnails/Heirlooms - Brass.png' },
  { id: 'heirlooms-nickel', name: 'Heirlooms - Nickel', image: '/assets/glass/thumbnails/Heirlooms - Nickel.png' },
  { id: 'majestic-nickel', name: 'Majestic - Nickel', image: '/assets/glass/thumbnails/Majestic - Nickel.png' },
  { id: 'majestic-patina', name: 'Majestic - Patina', image: '/assets/glass/thumbnails/Majestic - Patina.png' },
  { id: 'monterey-nickel', name: 'Monterey - Nickel', image: '/assets/glass/thumbnails/Monterey - Nickel.png' },
  { id: 'monterey-patina', name: 'Monterey - Patina', image: '/assets/glass/thumbnails/Monterey - Patina.png' },
  { id: 'nouveau-nickel', name: 'Nouveau - Nickel', image: '/assets/glass/thumbnails/Nouveau - Nickel.png' },
  { id: 'nouveau-patina', name: 'Nouveau - Patina', image: '/assets/glass/thumbnails/Nouveau - Patina.png' },
  { id: 'hrt-nouveau-nickel', name: 'Nouveau - Nickel', image: '/assets/glass/thumbnails/Nouveau - Nickel.png' },
  { id: 'hrt-nouveau-patina', name: 'Nouveau - Patina', image: '/assets/glass/thumbnails/Nouveau - Patina.png' },
  ...
  { id: 'f-f10l', name: 'F10L', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f-f15wh', name: 'F15 White Grid', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f-prairie-internal', name: 'Prairie Internal', image: '/assets/glass/thumbnails/Clear-option.png' },
  ...
  { id: 'f-ten-lite', name: 'Ten Lite', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f-clear-f10', name: 'F10 – Clear Full Lite - Standard', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f-clear-f10l', name: 'F10 – Clear Full Lite - Low-E', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f-clear-no-grids', name: 'Clear Glass with No Grids', image: '/assets/glass/thumbnails/Clear-option.png' },
  ...
  { id: 'f-clear-nonstock', name: 'NONSTOCKCL – Non-Stock Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f-clic-nogrid', name: 'NOGRID – No Grids', image: '/assets/glass/thumbnails/Clear-option.png' },
  ...
  { id: 'f48-clear-no-grids', name: 'Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  ...
  { id: 'f48-clear-nonstock', name: 'NONSTOCKCL – Non-Stock', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f48-blinds-white', name: 'FRLB48 – 3/4 Lite Blinds - White Blinds', image: '/assets/glass/thumbnails/Blinds.png' },
  { id: 'f48-clic-nogrid', name: 'NOGRID – No Grids', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'f48-clic-ext-12l', name: 'External Grids - 12 Lite', image: '/assets/glass/thumbnails/EXTG.png' },
  { id: 'frt-clear-f17rt', name: 'F17RT - 17 Lite Ext Grids Round Top', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'hrt-clear-s11rt', name: 'S11RT - Half Round Top Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'n-clear-ncl', name: 'NCL - Clear Glass Nine Panel', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'qa-clear-qacl', name: 'QACL - Quarter Arch Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'sat-clear-nonstock', name: 'NONSTOCKCL - Non-Stock Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'so-clear-nonstock', name: 'NONSTOCKCL - Non-Stock Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'so-clear-small-no-coating', name: 'Small Oval Clear - No Low-E', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 'so-clear-small-low-e', name: 'Small Oval Clear - Low-E', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 's-clear-s5', name: 'Clear Half Lite - S5 Standard', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 's-clear-no-grids', name: 'Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 's-clear-grids', name: 'Clear Glass with Grids', image: '/assets/glass/thumbnails/CR14PL Craftsman Divided Lites.png' },
  { id: 's-clear-s5l', name: 'Clear Half Lite - S5L Low-E', image: '/assets/glass/thumbnails/Clear-option.png' },
  ...
  { id: 's-clear-sv6', name: 'Clear Grids and Vented - SV6 Half Lite Vented', image: '/assets/glass/thumbnails/Clear-option.png' },
  { id: 's-clear-nonstock', name: 'NONSTOCKCL - Non-Stock Clear Glass', image: '/assets/glass/thumbnails/Clear-option.png' },
  ...
  { id: 's-clic-nogrid', name: 'NOGRID - No Grids', image: '/assets/glass/thumbnails/Clear-option.png' },
