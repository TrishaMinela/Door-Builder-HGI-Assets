...
const glassThumbnailOptions = [
  ...
  { id: 'clear-low-e', name: 'Clear with Low-E', image: '/assets/glass/thumbnails/Clear.png' },
...
const f48Overlays: Record<string, string> = {
  ...
  steamed: '/assets/hgi-assets/Glass/F48/DECO/F48STE.png',
